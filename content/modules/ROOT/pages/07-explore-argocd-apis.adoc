...
. Navega a la URL de **Argo CD** de tu entorno e inicia sesión (credenciales del taller o SSO según configuración).
. En la lista de **Applications**, filtra por proyecto o por prefijo de nombre usado en el workshop.
