...
| https://kiali-openshift-cluster-observability-operator.__CLUSTER_DOMAIN__

| **Jaeger**
| Distributed tracing across microservices
| https://jaeger.__CLUSTER_DOMAIN__
|===
...
. Open Grafana at `https://grafana-observability.__CLUSTER_DOMAIN__`
...
. Open Kiali at `https://kiali-openshift-cluster-observability-operator.__CLUSTER_DOMAIN__`
...
. Open Jaeger at `https://jaeger.__CLUSTER_DOMAIN__`
