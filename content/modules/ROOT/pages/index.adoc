...
Tu usuario asignado es `__USER_NAME__`.

Tu namespace de trabajo es **`__USER_NAME__-neuralbank`**. Todos los servicios que crees con las Software Templates se desplegarán ahí.

TIP: Si accediste desde el portal de registro, tu usuario ya está configurado automáticamente. Si no, ingresá tu username en el campo **Username** de la barra superior.
...
* **n8n (Workflow Automation)**: https://n8n.{cluster_domain}
