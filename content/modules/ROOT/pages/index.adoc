...
| **Developer Hub**
| https://backstage-developer-hub-developer-hub.__CLUSTER_DOMAIN__

| **Gitea**
| https://gitea-gitea.__CLUSTER_DOMAIN__

| **ArgoCD**
| https://openshift-gitops-server-openshift-gitops.__CLUSTER_DOMAIN__

| **Keycloak**
| https://rhbk.__CLUSTER_DOMAIN__/admin/master/console

| **Grafana**
| https://grafana-observability.__CLUSTER_DOMAIN__

| **Mailpit**
| https://n8n-mailpit-openshift-lightspeed.__CLUSTER_DOMAIN__

| **Showroom**
| https://showroom-from-zero-to-hero.__CLUSTER_DOMAIN__

| **OpenShift Console**
| https://console-openshift-console.__CLUSTER_DOMAIN__
|===
